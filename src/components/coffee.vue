        ...
        <div class="container">
            <div class="row text-center">
                ...
                <h6 class="col-md-12 mt-md-5" data-aos="zoom-in" data-aos-duration="2000">
                    ...
                    そして味の良さ・もてなしのやわらかさ・空間ののびやかさ……<br>
                    他店とは一線を画すサービスでお迎えしております。<br>
                ...
                <div class="col-md-6 space" style="text-align:left;" >
                    ...
                    しかも少量でしか生産していません。
                    お客様に最高のコーヒーだけを
                    お届けすることが珈琲館のモットーなのです。
                    そこにはどんな妥協も許されません。
                    <br><br>
                    特に炭火焙煎のコーヒーは、木炭の最高級品として
                    知られる国産備長炭に着目することで生まれた
                    オリジナリティーの高いコーヒーといえましょう。
                    厳選された豆を独自の焙煎技術でひと粒ひと粒丁寧に
                    煎り上げてつくられた、
